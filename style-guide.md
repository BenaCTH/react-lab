...
* 基于Airbnb React/JSX Style Guide，并进行适当的修改。
* 原规范链接：https://github.com/airbnb/javascript/tree/master/react
...
## redux
  ...
  - 如果state特别复杂，需要redux管理，请分享给common team，一起讨论分析。
